...
// ES6에서는 class 문법 추가 -> oop방식을 구현할 수 있다.
class Shape {
    // 정적 메서드 : static
    //    -> new하지 않고도 클래스명, 메서드명으로 접근 가능함
  ...
  let s2 = Shape.create(10, 20);    // static 메서드는 new없이 사용할 수 있다.
  ...
  class Circle extends Shape {
    ...
    area() {
      if (this.radius == 0) {
        return super.area();    // 부모의 메서드 호출 : 키워드 super
      }
