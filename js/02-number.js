// JavaScript의 Number
// int, float 가리지 않고 산술 연산이 가능함
let n1 = 2021; // Literal : 소스코드에 입력된 데이터
...
console.log("-------------Casting: 타입변환");
// 선언 시 데이터 타입을 지정하지 않고 중간에 데이터 타입이 변경될 수 있다 
// -> 형변환이 필요한 경우 많다.
